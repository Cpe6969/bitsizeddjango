...
urlpatterns = [
    ...
    path('<str:pk>/update/', views.update_news, name='update_news'),
    path('<str:pk>/delete/', views.delete_news, name='delete_news'),
    path('upload-image/', views.upload_image, name='upload_news_image'),
